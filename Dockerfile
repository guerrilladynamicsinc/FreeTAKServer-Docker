...
#MAP
RUN wget https://github.com/FreeTAKTeam/FreeTAKHub/releases/download/v${FTS_MAP_VERSION}/FTH-webmap-linux-${FTS_MAP_VERSION}.zip     -O /opt/FTH-webmap-linux-${FTS_MAP_VERSION}.zip &&\
    cd /opt &&\
